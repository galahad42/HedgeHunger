...
class AppNavigationScreen extends StatelessWidget {
                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapOnboardingscreenTwo(context);
                                            },
                                            child: Container(
                                                decoration:
                                                    AppDecoration.fillWhiteA700,
  ...
  /// Navigates to the donateFoodScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the donateFoodScreen.
  onTapDonatefood(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.donateFoodScreen);
  }
  ...
  /// Navigates to the onboardingScreenZeroScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the onboardingScreenZeroScreen.
  onTapOnboardingscreenZero(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.onboardingScreenZeroScreen);
  }
  ...
  /// Navigates to the currentEventsScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the currentEventsScreen.
  onTapCurrentevents(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.currentEventsScreen);
  }
  ...
  onTapNGOscreen(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.ngoScreen);
  }

  /// Navigates to the eventScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the eventScreen.
  onTapEventscreen(BuildContext context) {
